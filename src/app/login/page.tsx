...
import { supabase } from "@/utils/supabase"; // cspell:disable-line
...
const Page: React.FC = () => {
  ...
  return (
    <main className="px-4 py-6 max-w-md mx-auto">
      <div className="mb-6">
        <div className="text-2xl sm:text-3xl font-bold">ログイン</div>
      </div>
      ...
      >
        <div className="space-y-1">
          <label htmlFor="email" className="block font-bold text-sm sm:text-base">
        ...
        <div className="space-y-1">
          <label htmlFor="password" className="block font-bold text-sm sm:text-base">
